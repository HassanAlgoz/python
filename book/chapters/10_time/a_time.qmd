...
ومما تدعمه مكتبة `dateutil` أفضل بكثير من المكتبة الأساسية، [قراءة التواريخ](https://dateutil.readthedocs.io/en/stable/examples.html#parse-examples) إذ نحتاج لذلك عند استقبال معلومات من الشبكة أو من ملفات أو من المستخدمين:
