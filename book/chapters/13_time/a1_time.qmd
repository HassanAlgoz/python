...
هذا الباب إثرائي، لا يعتمد عليه ما بعده. فإن شئت الرجوع إليه في وقتٍ لاحق فلا بأس.
...
ويرشدنا مرجع المكتبة للتوسع في استعمال قاعدة بيانات المناطق الزمنية، والقدرة على تفسير التواريخ والأوقات بمرونة لاستخدام مكتبة [`dateutil`](https://dateutil.readthedocs.io/en/stable/) المتوفرة في PyPI.
