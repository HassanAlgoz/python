...
إذا كانت البرمجيات إنما تنحصر في الجمع والطرح ونحو ذلك فإنها لا تعدوا أن تكون آلة حاسبة.
لكن ليس الحال كذلك. بل لا يكاد يخلو برنامج مفيد من اتخاذ قرارات مغايرة بناءً على اختلاف المعطيات.
ومن هنا وجبت معرفة كيفية **التحكم في سير الأوامر** (Control-flow) بما يكون في المتغيرات التي تمثل المعطيات.

فمثلاً؛ تريد أن تجعل السيارة الآلية تتقيَّد بالسرعة القانونية للشارع بحسبه.
أو تريد أن تؤقِّتَ لإيقاف المكيِّف حتى تستيقظ في الصباح الباكر.
أو تريد أن يضيء المصباح عند استشعار حساس الحركة بدخول شخصٍ إلى الغرفة.

فهذه خوارزميات تحتاج إلى اتخاذ قرارات بناء على **حال مكانية أو زمانية أو واقعية**.

و**الخوارزمية** (Algorithm) هي تسيير معالجات على معطيات لغرض الوصول لنتيجة محددة.
ولك أن تقول: هي الانتقال من حال إلى حال.

وتكتب بالنص البرمجي حيث تنتظم أوامر النص البرمجي في ثلاثة أنماط:
