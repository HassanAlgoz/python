...
2. **التكرار**: تكرار تنفيذ قطعة كود عددًا من المرات أو معلَّقًا بتمام شرط
...
1. كلمة `True` (وتساوي الرقم `1`) وتعبِّر عن تحقق الفعل
2. كلمة `False` (وتساوي الرقم `0`) وتعبِّر عن عدم التحقق الفعل
...
- **سرد متوالية** (`for`): حيث يعيَّن متغير التكرار لكل عنصر في المتوالية، واحدًا تلوَ الآخر. (وسيأتي ذكره في [باب المتسلسلات](../05_sequences/a_sequences.qmd))
...
لاحظ أن نسيان جملة الزيادة (`i += 1`) يجعل الشرط دائمًا صحيحًا، فيدور البرنامج في **حلقة لا نهيائة** ولا يخرج أبدًا. ويعتبر هذا خطأ برمجيًّا يتعذر على الكود التعامل معه بنفسه؛ بل يجب على المبرمج أن يكتشفه. وسيأتي الكلام عن أنواع الأخطاء في البرمجة في [باب الأخطاء](../11_errors/a1_errors.qmd).
