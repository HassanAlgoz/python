...
# مسائل في توالي الأوامر {.unnumbered}
...
إليك هذه القصاصة في استعمال مكتبة العشوائية ([`random`](https://docs.python.org/3/library/random.html)) لاختيار عنصر من قائمة بشكل عشوائي:
