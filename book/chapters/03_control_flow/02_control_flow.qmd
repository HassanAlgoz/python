...
فلا يكاد يخلو برنامج مفيد من اتخاذ قرارات مغايرة بناءً على اختلاف المعطيات.
ومن هنا وجبت معرفة كيفية **التحكم في سير الأوامر** (Control-flow) بما يكون في المتغيرات التي تمثل المعطيات.

و**الخوارزمية** (Algorithm) هي تسلسل معين من المعالجات على معطيات معينة ليؤدي إلى نتيجة معينة.
...
الجملة الشرطية هي جملة مركَّبة من كلمة `if` وتعبير منطقي ثم الجمل التي يتعلق تنفيذها بناءً على هذا الشرط. ويجب أن تكون حذوها، على النحو التالي:
