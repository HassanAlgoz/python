...
[**الاستثناء**](https://docs.python.org/3.13/tutorial/errors.html) (Exception) هو خروج البرنامج عن المسار المثالي. ويسمى أيضًا **الخطأ العملي** (Runtime Error). مثل:
