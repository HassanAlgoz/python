...
تتخذ بايثون نموذجًا في البرمجة يسمى **البرمجة الشيئية**؛ وفكرتها تدور حول إسناد المتغيرات والأفعال **لشيء** مُعَيَّنٍ من **نوع** ما.

فمثلاً: نوع القائمة يُنشأُ مِنهُ قائمة معيَّنة (هي الشيء) يُسنَدُ إليها أفعال الإضافة والحذف والتعديل فتحدثُ فيها. فيُمكن أن يكون لدينا قائمتان الأولى شيء والثانية شيءٌ آخر مختلفٌ عنه ولو تطابقت أسماء الأفعال والمتغيرات بينهم.
