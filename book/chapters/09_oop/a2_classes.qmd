...
3. **التخصيص**: حيث نخفي إجراءات السلسلة (الحذف والإضافة والتعديل ونحوها) وراء أفعال محددَّة في صنف جديد نسميه **الطابور**
4. **التسلسل**: وهو النوع الذي يرتبط بمثله. كالشجرة، فروعها أصولٌ لفروع، وهكذا يتسلسل الأمر حتى نصل إلى الثمار.
