...
**المجموعة** ([`set`](https://docs.python.org/3/reference/datamodel.html#set-types)) هي جمع متغير من عناصر مرقومة فريدة بلا ترتيب.

- **متغير**: يعني أنها تقبل الإضافة والحذف والتعديل
- **مرقومة**: هي القابلة للرقم (`hash`) - وسيأتي بيانه
...
وهذه الخصوصية تكمن في سرعة هذا الإجراء في المجموعة مقارنة بعملة في التسلسل مثلاً:
...
إن أردت مزيدًا من التفاصيل فإليك هذا الرابط: [https://www.w3schools.com/dsa/dsa_data_hashsets.php](https://www.w3schools.com/dsa/dsa_data_hashsets.php).
