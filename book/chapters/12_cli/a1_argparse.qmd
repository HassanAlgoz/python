...
البرمجيات في الأصل ليس لها واجهة مرئية إلا بجهد خاصّ لإنشاء هذه الواجهة، واختلاف أنظمة التشغيل يجعل هذا الأمر صعبًا على المطورين، فالواجهة التي على نظام ويندوز لها طريقة تختلف عن واجهة لينكس، وتختلف عن واجهة الماك. وكذلك إذا جئنا للأجهزة اللوحية والكفية. وقد يكون الحل الأمثل لذلك استعمال [حزمة برمجيات فلتر (Flutter)](https://flutter.dev/) المطورة من قِبَل شركة غوغل (Google) التي تستعمل لغة دارت (Dart) وليس بايثون؛ لكن ليس صعبًا أن تتعلم لغة جديدة!

فإذا أردت إنشاء واجهة رسومية دون الخروج من بايثون، فلديك مكتبة `tkinter` لكنها غير مناسبة للأجهزة اللوحية والكفية، وإنما للأجهزة المكتبية. وقد وجدت توصية في توثيق بايثون بكتاب: [Tkinter الحديثة لمطوري بايثون المشغولين](https://tkdocs.com/book.html).

وأبسط طريقة للتعامل مع البرمجيات بدون الحاجة إلى واجهة رسومية، هي نافذة الأوامر. ونحن ندرك أن ذلك ليس للمستخدم العادي، ولكن لمن لا يهاب الشاشة السوداء.
