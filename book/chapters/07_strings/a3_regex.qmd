...
**التعبير النمطي** ([Regular Expression](https://en.wikipedia.org/wiki/Regular_expression)): طريقة لتحديد نمط متسلسل من الأحرف. والغرض منه: البحث عن هذا النمط في نص ما.
...
وهذا المحرر يستعمل محرك بايثون نفسه: [pythex](https://pythex.org/).
