...
ويسمى الدالة (Function) أو الروتين (Routine) أو البرنامج الفرعي (Sub-Program). ونقول استدعي الإجراء (Call) أو نفذه (Execute). وتسمى مكان القطعة التي قامت بالاستدعاء: **موقع الاستدعاء** (Call-site).
...
فأي إجراء يتم تعريفه؛ كالمتغير الذي يتم تعريفه: هو نص برمجي محفوظ ينتظر الاستدعاء حتى يحضر في ذاكرة البرنامج في ظرف تنفيذي ويتم تشغيله بعوامل معيَّنة.
...
وكذلك العوامل المعيَّنة بالاسم، لكن بالنجمتين `**` وتكون قاموسًا (وسيأتي الكلام عنه في [باب المجموعة المرقومة](../06_mapping/a1_set.qmd)) ومعنى الكلمة `kwargs` هو: Keyword Arguments:
