...
تمثل الأصناف في لغة بايثون طريقة لوصف المجردات؛ مثل: النقطة `Point` كما رأينا.

ومن الخصائص الممتعة في بناء البرمجيات: العلاقات بين المجردات في المستويات المختلفة من التجريد. وسنمثل بمثالين:

1. **التركيب**: حيث نعرِّف صِنف **المضلَّع** أنه مركَّب من **سلسلة + نقاط** ونركِّب من عوامل اللغة ما يجعله يشبه **المجموعات**
2. **التخصيص**: حيث نخفي إجراءات السلسلة (الحذف والإضافة والتعديل ونحوها) وراء أفعال محددَّة في صنف جديد نسميه **الطابور**
...
أما قبول الإجراء `len` لأصناف مغايرة عن بعضها فهي خاصيَّة **تعدد الأشكال** [(Polymorphism)](https://en.wikipedia.org/wiki/Polymorphism_(computer_science)): أي أن الإجراء الواحد يقبل أصناف متعددة في الحقيقة لكنَّها في تُظهر نفس السلوك الخارجي. بعبارة أخرى نقول:
...
تبين بهذا محاكاة بعض إجراءات الحاويات الأساسية مثل `list` و`set` و`tuple` و`str` و`dict`. وقد تقدَّم معنا أن النقطة تستطيع محاكاة الأنواع العددية باستعمال الفعل المخصص للجمع `+` الذي هو `__add__`.
