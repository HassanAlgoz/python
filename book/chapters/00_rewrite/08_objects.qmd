...
ومن ذلك **الوراثة** (Inheritence) وهي عمليَّة **تخصيص** (Sub-classing) بحيث يكون النوع المخصص مستمدًّا من نوعٍ عام.
...
ومنها أيضً أنواع [التسلسل](https://docs.python.org/3/reference/datamodel.html#sequences):

```{mermaid}
flowchart BT
  Sequence
  MutableSequence -- "is a" --> Sequence
...
ومنها أيضً أنواع [المجموعات](https://docs.python.org/3/reference/datamodel.html#set-types):
