...
| العربية | الإنجليزية |
|------------------|---------------------|
| التوقيت العالمي المنسق | Coordinated Universal Time (UTC) |
| المناطق الزمنية | Time Zones |
| التوقيت المحلي | Local Time |
| التوقيت الصيفي | Daylight Saving Time |
| قاعدة بيانات المناطق الزمنية | Time Zone Database (tz database) |
| وقت التقويم | Calendar Time |
| فجر نظام يونكس | Unix Epoch |
| التاريخ الهجري | Hijri Date |
| التاريخ الميلادي/الجريجوري | Gregorian Date |
| الساعات المتغيرة | Variable Hours |
| الساعات الميكانيكية الثابتة | Fixed Mechanical Hours |
| الساعة الشمسية/المزولة | Sundial |
| الساعة المتأرجحة | Pendulum Clock |
| الكرونومتر | Chronometer |
| مذبذب الكوارتز | Quartz Oscillator |
| الساعة الذرية | Atomic Clock |
| ساعة شعاع السيزيوم | Cesium Beam Clock |
| ساعة نافورة السيزيوم | Cesium Fountain Clock |
| الساعة الضوئية | Optical Clock |
