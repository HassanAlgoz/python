...
![[FIFO (first in, first out) queue](https://en.wikipedia.org/wiki/Queue_(abstract_data_type))
...
- والإجراء `dequeue` نطبقع عن طريق الإجراء `list.pop(0)` ..
