...
ولأن الملف يعتبر [**مدير سياق** (Context Manager)](https://docs.python.org/3/reference/datamodel.html#with-statement-context-managers) فيمكن استعمال جملة السياق `with` ليتم إغلاق الملف تلقائيّا عند نهاية الجملة التي تنتهي بنهاية قطعة الكود المحددة بالمحاذاة. وذلك على النحو التالي:
