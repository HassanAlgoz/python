...
رأينا التلسلسل الذي هو نوع مجموعة مرتبة.

نبحث في هذا الباب عن نوعين آخرين:

- المجموعة الرياضية
- المجموعة الدالة (المتمثلة في صنف القاموس)

## المجموعة الرياضية

**المجموعة الرياضية** ([`set`](https://docs.python.org/3/library/stdtypes.html#set)) تحوي أشياء فريدة مرقومة بغير ترتيب. ونظيرها الثابت (الذي لا يقبل التغيير) هو المجموعة الرياضية الجامدة ([`frozenset`](https://docs.python.org/3/library/stdtypes.html#frozenset)).

يمكن إنشاؤها باستعمال الإجراء المنشئ [`set()`](https://docs.python.org/3/library/stdtypes.html#set). ويفضل استعمال القوسين المتعرجين `{ }` لإنشاء المجموعة الرياضية:
...
وباعتبارها مجموعة متغيرة (Mutable Set)، فإنها تقبل [الإجراءات](https://docs.python.org/3/library/stdtypes.html#set.update) الأفعال التالية:
...
ذكرنا أن شرط عضوية العنصر أن يكون مرقومًا؛ وهذا **يجعل عملية البحث فيها قفزة واحدة**. ولكن ما هو المرقوم؟
...
سميناها **رياضية** لأنها تقبل العمليات في المجموعة المعروفة في الرياضيات:
...
**القاموس** ([`dict`](https://docs.python.org/3/library/stdtypes.html#dict)) هو مجموعة مرتبة من المرقومات الفريدة الدالة على أشياء.

يمكن إنشاؤه باستعمال الإجراء المنشئ [`dict()`](https://docs.python.org/3/library/stdtypes.html#dict) أو القوسين المتعرجين `{ }` على النحو التالي:
...
ولنصل إليها يمكن استعمال الإشارة بمرقوم:
...
يمكن إنشاء قاموس من سلسلتين باستعمال الإجراء [`zip()`](https://docs.python.org/3/library/functions.html#zip)، كما يلي:
