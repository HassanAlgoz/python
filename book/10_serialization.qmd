...
- صيغة لحفظ البيانات المرتبطة أو المضمنة، ونمثل لها بصيغة `json` وهي اختصار لكلمة: JavaScript Object Notation.
- صيغة لحفظ البيانات الجدولية، ونمثل لها بصيغة `csv` وهي اختصار لكلمة Comma-Separated Values. 

**سَلْسَلة البيانات** (Data Serialization) تشير لعملية تحويل الهياكل البيانية (مثل القاموس أو القائمة) من تمثيلها في لغة البرمجة (مثلاً: بايثون أو سي أو رَست) إلى صيغة يمكن تخزينها ونقلها بحيث يمكن قراءتها من طرف آخر لإعادتها إلى تمثيل متناسب معه. وعملية تحويل البيانات المسلسلة مرة أخرى إلى شكلها الأصلي تسمى فك التسلسل (Deserialization).

## البيانات المرتبطة أو المضمنة
