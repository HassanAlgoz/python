...
تعرف بايثون **المُكَرَّر** -بفتح الراء- ([`Iterable`](https://docs.python.org/3/glossary.html#term-iterable)) بأنه الشيء الذي يُنتج عنصرًا في كل كرة، (لأن من أفعاله `__iter__`).
ويندرج تحته **المُكَرِّر** -بكسر الراء- ([`Iterator`](https://docs.python.org/3/tutorial/classes.html#iterators)) وهو الشيء الذي يتحكم بعملية التكرار (لأن من أفعاله `__next__`).
